...
struct MeshGeometry
{
    ...
    /*   Change   */
    // 需要创建两个顶点缓冲区, CPU.
    Microsoft::WRL::ComPtr<ID3DBlob> VertexPositionBufferCPU = nullptr;
    Microsoft::WRL::ComPtr<ID3DBlob> VertexColorBufferCPU = nullptr;
    Microsoft::WRL::ComPtr<ID3DBlob> IndexBufferCPU = nullptr;

    // 需要创建两个顶点缓冲区, GPU.
    Microsoft::WRL::ComPtr<ID3D12Resource> VertexPositionBufferGPU = nullptr;
    Microsoft::WRL::ComPtr<ID3D12Resource> VertexColorBufferGPU = nullptr;
    Microsoft::WRL::ComPtr<ID3D12Resource> IndexBufferGPU = nullptr;

    // 上传堆也需要两个.
    Microsoft::WRL::ComPtr<ID3D12Resource> VertexPositionBufferUploader = nullptr;
    Microsoft::WRL::ComPtr<ID3D12Resource> VertexColorBufferUploader = nullptr;
    Microsoft::WRL::ComPtr<ID3D12Resource> IndexBufferUploader = nullptr;

    UINT VertexPositionByteStride = 0;
    UINT VertexColorByteStride = 0;
    UINT VertexPositionBufferByteSize = 0;
    ...
    D3D12_VERTEX_BUFFER_VIEW VertexPositionBufferView()const
    {
        ...
        vbv.BufferLocation = VertexPositionBufferGPU->GetGPUVirtualAddress();
        vbv.StrideInBytes = VertexPositionByteStride;
        vbv.SizeInBytes = VertexPositionBufferByteSize;
	...
	{
        VertexPositionBufferUploader = nullptr;
